...
# 🔵 核心定義：大分類 (5日累積) 與 細分產業 (當日即時)
MAJOR_S_DEF = {"半導體": ["2330.TW", "2454.TW"], "電子零組件": ["2317.TW", "2308.TW"], "建材營造": ["2542.TW", "2501.TW"], "電腦週邊": ["2382.TW", "2357.TW"], "航運類股": ["2603.TW"]}
SUB_I_DEF = {
...
def fetch_capital_monitor():
    ...
    try:
        # 抓取 10 天數據，確保 5日累積(波段) 的計算真實 (避開週末)
